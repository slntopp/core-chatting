...
type GetawayRequest struct {
	...
	GatewayChatId int64  `protobuf:"varint,2,opt,name=gateway_chat_id,json=gatewayChatId,proto3" json:"gateway_chat_id,omitempty"`
}
...
func (x *GetawayRequest) GetGatewayChatId() int64 {
	if x != nil {
...
var file_cc_cc_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x0d, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x43, 0x68, 0x61, 0x74, 0x49,
