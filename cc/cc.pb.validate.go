...
// Validate checks the field values on Merge with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on Merge with the rules defined in the
// proto definition for this message. If any rules are violated, the result is
// a list of violation errors wrapped in MergeMultiError, or nil if none found.
func (m *Merge) ValidateAll() error {
	return m.validate(true)
}

func (m *Merge) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// MergeMultiError is an error wrapping multiple validation errors returned by
// Merge.ValidateAll() if the designated constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m MergeMultiError) AllErrors() []error { return m }

// MergeValidationError is the validation error returned by Merge.Validate if
// the designated constraints aren't met.
...
// Field function returns field value.
func (e MergeValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e MergeValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e MergeValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e MergeValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e MergeValidationError) ErrorName() string { return "MergeValidationError" }
...
var _ error = MergeValidationError{}
...

	{
		...
		for _, key := range sorted_keys {
			...
			if all {
				...
				case interface{ ValidateAll() error }:
					if err := v.ValidateAll(); err != nil {
						errors = append(errors, ListChatsRequestValidationError{
				...
				if err := v.Validate(); err != nil {
					return ListChatsRequestValidationError{
						field:  fmt.Sprintf("Filters[%v]", key),
						reason: "embedded message failed validation",
						cause:  err,
					}
...
// Validate checks the field values on SetBotStateRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SetBotStateRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SetBotStateRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SetBotStateRequestMultiError, or nil if none found.
func (m *SetBotStateRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *SetBotStateRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
...

	{
		...
		for _, key := range sorted_keys {
			...
			if all {
				...
				case interface{ ValidateAll() error }:
					if err := v.ValidateAll(); err != nil {
						errors = append(errors, SetBotStateRequestValidationError{
				...
				if err := v.Validate(); err != nil {
					return SetBotStateRequestValidationError{
						field:  fmt.Sprintf("State[%v]", key),
						reason: "embedded message failed validation",
						cause:  err,
					}
	...
	if m.Escalated != nil {
		// no validation rules for Escalated
	}

	if m.SkipReview != nil {
		// no validation rules for SkipReview
	}

	if len(errors) > 0 {
		return SetBotStateRequestMultiError(errors)
	}

	return nil
}

// SetBotStateRequestMultiError is an error wrapping multiple validation errors
// returned by SetBotStateRequest.ValidateAll() if the designated constraints
// aren't met.
type SetBotStateRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SetBotStateRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SetBotStateRequestMultiError) AllErrors() []error { return m }

// SetBotStateRequestValidationError is the validation error returned by
// SetBotStateRequest.Validate if the designated constraints aren't met.
type SetBotStateRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SetBotStateRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SetBotStateRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SetBotStateRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SetBotStateRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SetBotStateRequestValidationError) ErrorName() string {
	return "SetBotStateRequestValidationError"
}

// Error satisfies the builtin error interface
func (e SetBotStateRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSetBotStateRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SetBotStateRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SetBotStateRequestValidationError{}
...
// Validate checks the field values on PollVote with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *PollVote) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PollVote with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in PollVoteMultiError, or nil
// if none found.
func (m *PollVote) ValidateAll() error {
	return m.validate(true)
}

func (m *PollVote) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// PollVoteMultiError is an error wrapping multiple validation errors returned
// by PollVote.ValidateAll() if the designated constraints aren't met.
type PollVoteMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PollVoteMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PollVoteMultiError) AllErrors() []error { return m }

// PollVoteValidationError is the validation error returned by
// PollVote.Validate if the designated constraints aren't met.
type PollVoteValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e PollVoteValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PollVoteValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PollVoteValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PollVoteValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PollVoteValidationError) ErrorName() string { return "PollVoteValidationError" }

// Error satisfies the builtin error interface
func (e PollVoteValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = PollVoteValidationError{}
...
func (m *Poll) validate(all bool) error {
	...
	{
		sorted_keys := make([]string, len(m.GetVotes()))
		i := 0
		for key := range m.GetVotes() {
			sorted_keys[i] = key
			i++
		}
		sort.Slice(sorted_keys, func(i, j int) bool { return sorted_keys[i] < sorted_keys[j] })
		for _, key := range sorted_keys {
			...
			// no validation rules for Votes[key]
...
func (m *Defaults) validate(all bool) error {
	...
	// no validation rules for Templates

	if all {
		switch v := interface{}(m.GetBot()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, DefaultsValidationError{
					field:  "Bot",
	...
	} else if v, ok := interface{}(m.GetBot()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return DefaultsValidationError{
				field:  "Bot",
				reason: "embedded message failed validation",
...
// Validate checks the field values on FetchDefaultsRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on FetchDefaultsRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// FetchDefaultsRequestMultiError, or nil if none found.
func (m *FetchDefaultsRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *FetchDefaultsRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for FetchTemplates

	if len(errors) > 0 {
		return FetchDefaultsRequestMultiError(errors)
	}

	return nil
}

// FetchDefaultsRequestMultiError is an error wrapping multiple validation
// errors returned by FetchDefaultsRequest.ValidateAll() if the designated
// constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m FetchDefaultsRequestMultiError) AllErrors() []error { return m }

// FetchDefaultsRequestValidationError is the validation error returned by
// FetchDefaultsRequest.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e FetchDefaultsRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e FetchDefaultsRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e FetchDefaultsRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e FetchDefaultsRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e FetchDefaultsRequestValidationError) ErrorName() string {
	return "FetchDefaultsRequestValidationError"
}
...
func (e FetchDefaultsRequestValidationError) Error() string {
	...
	return fmt.Sprintf(
		"invalid %sFetchDefaultsRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = FetchDefaultsRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = FetchDefaultsRequestValidationError{}
