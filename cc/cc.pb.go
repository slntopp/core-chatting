...
var file_cc_cc_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0xc6, 0x02, 0x0a, 0x07, 0x4d, 0x65,
	...
	0x52, 0x07, 0x72, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x63, 0x68,
	...
	0x45, 0x5f, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x45, 0x44, 0x10, 0x07, 0x32, 0x9d, 0x01, 0x0a, 0x08,
	...
	0x73, 0x61, 0x67, 0x65, 0x32, 0x94, 0x01, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x73, 0x41, 0x50,
	0x49, 0x12, 0x19, 0x0a, 0x02, 0x4d, 0x65, 0x12, 0x09, 0x2e, 0x63, 0x63, 0x2e, 0x45, 0x6d, 0x70,
	0x74, 0x79, 0x1a, 0x08, 0x2e, 0x63, 0x63, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x12, 0x28, 0x0a, 0x0d,
	0x46, 0x65, 0x74, 0x63, 0x68, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x73, 0x12, 0x09, 0x2e,
	...
	0x63, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x22, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x4d, 0x65,
	0x6d, 0x62, 0x65, 0x72, 0x73, 0x12, 0x09, 0x2e, 0x63, 0x63, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79,
...
var file_cc_cc_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
...
var file_cc_cc_proto_depIdxs = []int32{
	...
	8,  // 7: cc.Messages.messages:type_name -> cc.Message
	10, // 8: cc.Users.users:type_name -> cc.User
	2,  // 9: cc.Event.type:type_name -> cc.EventType
	5,  // 10: cc.Event.chat:type_name -> cc.Chat
	8,  // 11: cc.Event.msg:type_name -> cc.Message
	15, // 12: cc.ChatMeta.DataEntry.value:type_name -> google.protobuf.Value
	5,  // 13: cc.ChatsAPI.Create:input_type -> cc.Chat
	5,  // 14: cc.ChatsAPI.Update:input_type -> cc.Chat
	5,  // 15: cc.ChatsAPI.Get:input_type -> cc.Chat
	3,  // 16: cc.ChatsAPI.List:input_type -> cc.Empty
	5,  // 17: cc.ChatsAPI.Delete:input_type -> cc.Chat
	5,  // 18: cc.MessagesAPI.Get:input_type -> cc.Chat
	8,  // 19: cc.MessagesAPI.Send:input_type -> cc.Message
	8,  // 20: cc.MessagesAPI.Update:input_type -> cc.Message
	8,  // 21: cc.MessagesAPI.Delete:input_type -> cc.Message
	3,  // 22: cc.UsersAPI.Me:input_type -> cc.Empty
	3,  // 23: cc.UsersAPI.FetchDefaults:input_type -> cc.Empty
	12, // 24: cc.UsersAPI.Resolve:input_type -> cc.Users
	3,  // 25: cc.UsersAPI.GetMembers:input_type -> cc.Empty
	3,  // 26: cc.StreamService.Stream:input_type -> cc.Empty
	5,  // 27: cc.ChatsAPI.Create:output_type -> cc.Chat
	5,  // 28: cc.ChatsAPI.Update:output_type -> cc.Chat
	5,  // 29: cc.ChatsAPI.Get:output_type -> cc.Chat
	6,  // 30: cc.ChatsAPI.List:output_type -> cc.Chats
	5,  // 31: cc.ChatsAPI.Delete:output_type -> cc.Chat
	9,  // 32: cc.MessagesAPI.Get:output_type -> cc.Messages
	8,  // 33: cc.MessagesAPI.Send:output_type -> cc.Message
	8,  // 34: cc.MessagesAPI.Update:output_type -> cc.Message
	8,  // 35: cc.MessagesAPI.Delete:output_type -> cc.Message
	10, // 36: cc.UsersAPI.Me:output_type -> cc.User
	11, // 37: cc.UsersAPI.FetchDefaults:output_type -> cc.Defaults
	12, // 38: cc.UsersAPI.Resolve:output_type -> cc.Users
	12, // 39: cc.UsersAPI.GetMembers:output_type -> cc.Users
	13, // 40: cc.StreamService.Stream:output_type -> cc.Event
