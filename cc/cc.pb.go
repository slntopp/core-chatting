...
var file_cc_cc_proto_rawDesc = []byte{
	...
	0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xcb, 0x02, 0x0a,
	...
	0x61, 0x72, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x74, 0x6f, 0x70, 0x69,
	0x63, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x22, 0x27, 0x0a, 0x05, 0x43, 0x68,
	...
	0xe0, 0x03, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x75,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x22, 0x9a, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x22, 0x6e, 0x0a, 0x0a, 0x44, 0x65, 0x70, 0x61, 0x72, 0x74, 0x6d, 0x65,
	...
	0x6d, 0x69, 0x6e, 0x73, 0x22, 0x30, 0x0a, 0x06, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x10,
	...
	0x41, 0x55, 0x4c, 0x54, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x46, 0x4f, 0x52, 0x5f, 0x42, 0x4f,
	0x54, 0x10, 0x01, 0x12, 0x0e, 0x0a, 0x0a, 0x41, 0x44, 0x4d, 0x49, 0x4e, 0x5f, 0x4f, 0x4e, 0x4c,
	0x59, 0x10, 0x02, 0x2a, 0x96, 0x01, 0x0a, 0x09, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70,
	...
	0x47, 0x45, 0x5f, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x45, 0x44, 0x10, 0x07, 0x32, 0x9d, 0x01, 0x0a,
	...
	0x61, 0x74, 0x1a, 0x08, 0x2e, 0x63, 0x63, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x32, 0x96, 0x01, 0x0a,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x94, 0x01, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x73, 0x41,
	0x50, 0x49, 0x12, 0x19, 0x0a, 0x02, 0x4d, 0x65, 0x12, 0x09, 0x2e, 0x63, 0x63, 0x2e, 0x45, 0x6d,
	0x70, 0x74, 0x79, 0x1a, 0x08, 0x2e, 0x63, 0x63, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x12, 0x28, 0x0a,
	0x0d, 0x46, 0x65, 0x74, 0x63, 0x68, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x73, 0x12, 0x09,
...
var file_cc_cc_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_cc_cc_proto_goTypes = []interface{}{
	...
	nil,                     // 21: cc.Defaults.MetricsEntry
	nil,                     // 22: cc.StreamRequest.CommandsEntry
...
var file_cc_cc_proto_depIdxs = []int32{
	...
	23, // 11: cc.User.data:type_name -> google.protobuf.Struct
	13, // 12: cc.Metric.options:type_name -> cc.Option
	12, // 13: cc.Defaults.departments:type_name -> cc.Department
	21, // 14: cc.Defaults.metrics:type_name -> cc.Defaults.MetricsEntry
	11, // 15: cc.Users.users:type_name -> cc.User
	3,  // 16: cc.Event.type:type_name -> cc.EventType
	6,  // 17: cc.Event.chat:type_name -> cc.Chat
	9,  // 18: cc.Event.msg:type_name -> cc.Message
	22, // 19: cc.StreamRequest.commands:type_name -> cc.StreamRequest.CommandsEntry
	24, // 20: cc.ChatMeta.DataEntry.value:type_name -> google.protobuf.Value
	24, // 21: cc.Message.MetaEntry.value:type_name -> google.protobuf.Value
	14, // 22: cc.Defaults.MetricsEntry.value:type_name -> cc.Metric
	6,  // 23: cc.ChatsAPI.Create:input_type -> cc.Chat
	6,  // 24: cc.ChatsAPI.Update:input_type -> cc.Chat
	6,  // 25: cc.ChatsAPI.Get:input_type -> cc.Chat
	4,  // 26: cc.ChatsAPI.List:input_type -> cc.Empty
	6,  // 27: cc.ChatsAPI.Delete:input_type -> cc.Chat
	6,  // 28: cc.MessagesAPI.Get:input_type -> cc.Chat
	9,  // 29: cc.MessagesAPI.Send:input_type -> cc.Message
	9,  // 30: cc.MessagesAPI.Update:input_type -> cc.Message
	9,  // 31: cc.MessagesAPI.Delete:input_type -> cc.Message
	4,  // 32: cc.UsersAPI.Me:input_type -> cc.Empty
	4,  // 33: cc.UsersAPI.FetchDefaults:input_type -> cc.Empty
	16, // 34: cc.UsersAPI.Resolve:input_type -> cc.Users
	4,  // 35: cc.UsersAPI.GetMembers:input_type -> cc.Empty
	18, // 36: cc.StreamService.Stream:input_type -> cc.StreamRequest
	6,  // 37: cc.ChatsAPI.Create:output_type -> cc.Chat
	6,  // 38: cc.ChatsAPI.Update:output_type -> cc.Chat
	6,  // 39: cc.ChatsAPI.Get:output_type -> cc.Chat
	7,  // 40: cc.ChatsAPI.List:output_type -> cc.Chats
	6,  // 41: cc.ChatsAPI.Delete:output_type -> cc.Chat
	10, // 42: cc.MessagesAPI.Get:output_type -> cc.Messages
	9,  // 43: cc.MessagesAPI.Send:output_type -> cc.Message
	9,  // 44: cc.MessagesAPI.Update:output_type -> cc.Message
	9,  // 45: cc.MessagesAPI.Delete:output_type -> cc.Message
	11, // 46: cc.UsersAPI.Me:output_type -> cc.User
	15, // 47: cc.UsersAPI.FetchDefaults:output_type -> cc.Defaults
	16, // 48: cc.UsersAPI.Resolve:output_type -> cc.Users
	16, // 49: cc.UsersAPI.GetMembers:output_type -> cc.Users
	17, // 50: cc.StreamService.Stream:output_type -> cc.Event
