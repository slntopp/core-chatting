...
type Defaults struct {
	...
	Admins   []*User  `protobuf:"bytes,2,rep,name=admins,proto3" json:"admins,omitempty"`
}
...
func (x *Defaults) GetAdmins() []*User {
	if x != nil {
		return x.Admins
	}
	return nil
...
var file_cc_cc_proto_rawDesc = []byte{
	...
	0x22, 0x48, 0x0a, 0x08, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x73, 0x12, 0x1a, 0x0a, 0x08,
	0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08,
	0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x73, 0x12, 0x20, 0x0a, 0x06, 0x61, 0x64, 0x6d, 0x69,
	0x6e, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x63, 0x63, 0x2e, 0x55, 0x73,
	0x65, 0x72, 0x52, 0x06, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x73, 0x22, 0x27, 0x0a, 0x05, 0x55, 0x73,
	...
	0x65, 0x72, 0x73, 0x2a, 0x34, 0x0a, 0x04, 0x52, 0x6f, 0x6c, 0x65, 0x12, 0x0c, 0x0a, 0x08, 0x4e,
	...
	0x0a, 0x0a, 0x41, 0x44, 0x4d, 0x49, 0x4e, 0x5f, 0x4f, 0x4e, 0x4c, 0x59, 0x10, 0x01, 0x32, 0x82,
	...
	0x0b, 0x2e, 0x63, 0x63, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x55, 0x0a, 0x08,
	0x55, 0x73, 0x65, 0x72, 0x73, 0x41, 0x50, 0x49, 0x12, 0x28, 0x0a, 0x0d, 0x46, 0x65, 0x74, 0x63,
...
var file_cc_cc_proto_depIdxs = []int32{
	...
	8,  // 5: cc.Defaults.admins:type_name -> cc.User
	8,  // 6: cc.Users.users:type_name -> cc.User
	3,  // 7: cc.ChatsAPI.Create:input_type -> cc.Chat
	3,  // 8: cc.ChatsAPI.Update:input_type -> cc.Chat
	2,  // 9: cc.ChatsAPI.List:input_type -> cc.Empty
	3,  // 10: cc.ChatsAPI.Delete:input_type -> cc.Chat
	3,  // 11: cc.MessagesAPI.Get:input_type -> cc.Chat
	6,  // 12: cc.MessagesAPI.Send:input_type -> cc.Message
	6,  // 13: cc.MessagesAPI.Update:input_type -> cc.Message
	6,  // 14: cc.MessagesAPI.Delete:input_type -> cc.Message
	...
	9,  // 25: cc.UsersAPI.FetchDefaults:output_type -> cc.Defaults
	10, // 26: cc.UsersAPI.Resolve:output_type -> cc.Users
