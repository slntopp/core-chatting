...
var file_cc_cc_proto_rawDesc = []byte{
	...
	0x73, 0x67, 0x42, 0x06, 0x0a, 0x04, 0x69, 0x74, 0x65, 0x6d, 0x2a, 0x34, 0x0a, 0x04, 0x52, 0x6f,
	...
	0x07, 0x44, 0x45, 0x46, 0x41, 0x55, 0x4c, 0x54, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x46, 0x4f,
	0x52, 0x5f, 0x42, 0x4f, 0x54, 0x10, 0x01, 0x12, 0x0e, 0x0a, 0x0a, 0x41, 0x44, 0x4d, 0x49, 0x4e,
	0x5f, 0x4f, 0x4e, 0x4c, 0x59, 0x10, 0x02, 0x2a, 0x96, 0x01, 0x0a, 0x09, 0x45, 0x76, 0x65, 0x6e,
	...
	0x32, 0x9d, 0x01, 0x0a, 0x08, 0x43, 0x68, 0x61, 0x74, 0x73, 0x41, 0x50, 0x49, 0x12, 0x1c, 0x0a,
	...
	0x63, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x94, 0x01, 0x0a, 0x08, 0x55, 0x73,
	...
	0x73, 0x1a, 0x09, 0x2e, 0x63, 0x63, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x22, 0x0a, 0x0a,
	0x47, 0x65, 0x74, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x12, 0x09, 0x2e, 0x63, 0x63, 0x2e,
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x09, 0x2e, 0x63, 0x63, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x73,
	0x32, 0x31, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x20, 0x0a, 0x06, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x09, 0x2e, 0x63, 0x63,
	0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x09, 0x2e, 0x63, 0x63, 0x2e, 0x45, 0x76, 0x65, 0x6e,
...
var file_cc_cc_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_cc_cc_proto_goTypes = []interface{}{
	...
	nil,                     // 18: cc.ChatMeta.DataEntry
	nil,                     // 19: cc.Message.MetaEntry
	nil,                     // 20: cc.Defaults.MetricsEntry
...
var file_cc_cc_proto_depIdxs = []int32{
	...
	18, // 2: cc.ChatMeta.data:type_name -> cc.ChatMeta.DataEntry
	...
	19, // 9: cc.Message.meta:type_name -> cc.Message.MetaEntry
	9,  // 10: cc.Messages.messages:type_name -> cc.Message
	21, // 11: cc.User.data:type_name -> google.protobuf.Struct
	13, // 12: cc.Metric.options:type_name -> cc.Option
	12, // 13: cc.Defaults.departments:type_name -> cc.Department
	20, // 14: cc.Defaults.metrics:type_name -> cc.Defaults.MetricsEntry
	...
	22, // 19: cc.ChatMeta.DataEntry.value:type_name -> google.protobuf.Value
	22, // 20: cc.Message.MetaEntry.value:type_name -> google.protobuf.Value
	14, // 21: cc.Defaults.MetricsEntry.value:type_name -> cc.Metric
	6,  // 22: cc.ChatsAPI.Create:input_type -> cc.Chat
	6,  // 23: cc.ChatsAPI.Update:input_type -> cc.Chat
	6,  // 24: cc.ChatsAPI.Get:input_type -> cc.Chat
	4,  // 25: cc.ChatsAPI.List:input_type -> cc.Empty
	6,  // 26: cc.ChatsAPI.Delete:input_type -> cc.Chat
	6,  // 27: cc.MessagesAPI.Get:input_type -> cc.Chat
	9,  // 28: cc.MessagesAPI.Send:input_type -> cc.Message
	9,  // 29: cc.MessagesAPI.Update:input_type -> cc.Message
	9,  // 30: cc.MessagesAPI.Delete:input_type -> cc.Message
	4,  // 31: cc.UsersAPI.Me:input_type -> cc.Empty
	4,  // 32: cc.UsersAPI.FetchDefaults:input_type -> cc.Empty
	16, // 33: cc.UsersAPI.Resolve:input_type -> cc.Users
	4,  // 34: cc.UsersAPI.GetMembers:input_type -> cc.Empty
	4,  // 35: cc.StreamService.Stream:input_type -> cc.Empty
	6,  // 36: cc.ChatsAPI.Create:output_type -> cc.Chat
	6,  // 37: cc.ChatsAPI.Update:output_type -> cc.Chat
	6,  // 38: cc.ChatsAPI.Get:output_type -> cc.Chat
	7,  // 39: cc.ChatsAPI.List:output_type -> cc.Chats
	6,  // 40: cc.ChatsAPI.Delete:output_type -> cc.Chat
	10, // 41: cc.MessagesAPI.Get:output_type -> cc.Messages
	9,  // 42: cc.MessagesAPI.Send:output_type -> cc.Message
	9,  // 43: cc.MessagesAPI.Update:output_type -> cc.Message
	9,  // 44: cc.MessagesAPI.Delete:output_type -> cc.Message
	11, // 45: cc.UsersAPI.Me:output_type -> cc.User
	15, // 46: cc.UsersAPI.FetchDefaults:output_type -> cc.Defaults
	16, // 47: cc.UsersAPI.Resolve:output_type -> cc.Users
	16, // 48: cc.UsersAPI.GetMembers:output_type -> cc.Users
	17, // 49: cc.StreamService.Stream:output_type -> cc.Event
